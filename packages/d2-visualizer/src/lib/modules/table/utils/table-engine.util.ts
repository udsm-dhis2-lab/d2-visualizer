...
export class D2TableEngine extends TableDrawable {
    ...
    public drawTable(
        ...
        return tableConfiguration && tableConfiguration.isConsecutivePeDiff
            ? this.getDifferenceInConsecutivePe(tableDashboardItem, table)
            : table;
    }

    public getDifferenceInConsecutivePe(
        tableDashboardItem: TableDashboardItem,
        table: TablePayload
    ) {
        return {
    ...
    public getItemColor(tableDashboardItem: TableDashboardItem, value: number) {
        // Implement Method
        if (
            tableDashboardItem &&
            tableDashboardItem.visualization &&
            tableDashboardItem.visualization.legendSet &&
            tableDashboardItem.visualization.legendSet.legends &&
            tableDashboardItem.visualization.legendSet.legends.length
        ) {
